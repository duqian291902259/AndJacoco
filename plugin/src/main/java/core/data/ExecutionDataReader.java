...
import core.internal.data.CompactDataInput;
...
public class ExecutionDataReader {
	...
	private void readSessionInfo() throws IOException {
		...
		SessionInfo info=new SessionInfo(id, start, dump);
	...
	private void readExecutionData() throws IOException {
		...
		ExecutionData data=new ExecutionData(id, name, probes);
		data.setSessionInfo(info);
		executionDataVisitor
				.visitClassExecution(data);
	}
