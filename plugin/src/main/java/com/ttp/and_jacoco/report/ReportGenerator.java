 ...
 *
 *******************************************************************************/
package com.ttp.and_jacoco.report;
...
public class ReportGenerator {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        System.out.println("sourceDirs="+sourceDirs.get(0));
        System.out.println("reportDir="+reportDir);
        ReportGenerator generator = new ReportGenerator(execDir, classDirs, sourceDirs, reportDir);
        generator.create();
    }
